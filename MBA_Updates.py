...
fullpath_spec = "/Users/charlie/Documents/NEOUpdates/"  # MAC
...
new_MCA_names = getNewNames(Old_MCA,  MCA_names, new_MCA_names)
new_IMB_names = getNewNames(Old_IMB,  IMB_names, new_IMB_names)
new_MBA_names = getNewNames(Old_MBA,  MBA_names, new_MBA_names)
new_OMB_names = getNewNames(Old_OMB,  OMB_names, new_OMB_names)
